...
@Composable
fun SportsApp(
    windowSize: WindowWidthSizeClass, // <--- 1. Agregamos el tamaño de la ventana
    ...
    Scaffold(
        topBar = {
            SportsAppBar(
                isShowingListPage = uiState.isShowingListPage || contentType == SportsContentType.ListAndDetail,
